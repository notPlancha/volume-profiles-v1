...
//Thanks for Uzair Farooq for this library
...
function SoundProfiles(){
  ...
  */
  ...
  for (var i = 3; i > 0; i--) {
    ...
    if (volume === null || volume == "undefined") { //maybe shange this to check if it's number and between 0 and 1 TODO
      switch (i) {
        case 1:
          volume = "0.5";
          break;
    ...
    newDiv.addEventListener("contextmenu", function() { //check if working
      if (confirm("Save current volume to SoundProfile1?")) {
        ...
        Spicetify.LocalStorage.set("SoundProfile1", sound.toString());
      }
    })
